...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    _selectedCategoryId = widget.product.categoriaId.isNotEmpty
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Category>>(
        ...
        builder: (context, snapshot) {
          ...
          // Si el categoriaId actual no existeix a la llista (dades antigues),
          // el resetem a null per evitar errors al dropdown
